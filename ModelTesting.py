...
a, b, c, d, test, gt = Preprocessor1.Preprocessor.initial(x, y, z)
...
test = coo_matrix((data, (row, col)), shape=(len(test), 121))
...
for data in range(len(test)):
    ...
    #print(ypred)
    atttype = atttype.view(len(test), 1)
...
print("Test Accuracy: " + str(correct/len(test)))
#print(matrix)
